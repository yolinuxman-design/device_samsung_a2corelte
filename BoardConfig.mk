...
# Assert
TARGET_OTA_ASSERT_DEVICE := a2corelte,a2coreltewe,a2coreltedd,a2coreltejn,a2coreltexx
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE   := 0x54000000   # 0x54000000
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0x334000000
BOARD_CACHEIMAGE_PARTITION_SIZE    := 0x2800000
BOARD_FLASH_BLOCK_SIZE := 131072

# Prebuilt kernel boot image (mirrors working TWRP setup)
